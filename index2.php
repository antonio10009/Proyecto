...
<html lang="es">
    ...
    <link href="js/script11.js">
        ...
        <body>
                <form action="procesosave.php" method="POST" enctype="multipart/form-data">
                <fieldset>Ingrese los datos del juego</fieldset>
                    <input type="text" required class="nombre" id="nombre" name="nombre" placeholder="Ingrese el nombre" value=""><br/>
                    <input type="text" required class="calificacion" id="calificacion" name="calificacion" placeholder="Ingrese una calificación: Ej(E,T,M,A)"><br>
                    <select class="cater1" required name="categoria">
        ...
        <br>
        <select id="plataforma" required name="plataforma">
        ...
        <input type="text" id="descripcion" required class="descripcion" name="descripcion" placeholder="Ingrese una descripción" maxlength="250"><br>
        ...
        <div id="preview"></div>
        <input type="submit" id="enviar" value="Enviar" onclick=" location.href='mostrar.php' " class="envio">
