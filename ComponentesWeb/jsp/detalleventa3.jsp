<%-- 
    Document   : detalleventa3
    Created on : 31-05-2021, 12:00:03
    Author     : Antonio
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Detalle Venta</h1>
        <div class="text-center" for="Id" id="id">Id: 3 </div>
        <div class="text-center" for="Mouse" id="nombre">Nombre: Pendrive 8GB</label><br>
        <div class="text-center" for="Precio" id="precio">Precio: $4000</label><br> <br>
