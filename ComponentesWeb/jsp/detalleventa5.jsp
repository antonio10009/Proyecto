<%-- 
    Document   : detalleventa5
    Created on : 31-05-2021, 12:02:16
    Author     : Antonio
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Detalle Venta</h1>
        <div class="text-center" for="Id" id="id">Id: 5 </div>
        <div class="text-center" for="Mouse" id="nombre">Nombre: Kit de Limpieza</label><br>
        <div class="text-center" for="Precio" id="precio">Precio: $3000</label><br> <br>
