<%-- 
    Document   : detalleventa4
    Created on : 31-05-2021, 12:01:10
    Author     : Antonio
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Detalle Venta</h1>
        <div class="text-center" for="Id" id="id">Id: 4 </div>
        <div class="text-center" for="Mouse" id="nombre">Nombre: HDD Externo 500GB</label><br>
        <div class="text-center" for="Precio" id="precio">Precio: $50000</label><br> <br>
