<%-- 
    Document   : detalleventa2
    Created on : 31-05-2021, 11:57:52
    Author     : Antonio
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Detalle Venta</h1>
        <div class="text-center" for="Id" id="id">Id: 2 </div>
        <div class="text-center" for="Mouse" id="nombre">Nombre: Teclado</label><br>
        <div class="text-center" for="Precio" id="precio">Precio: $5000</label><br> <br>
